    ...
    <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] p-5">
      ...
      <div className="mt-4 border-t border-[var(--color-border)] pt-4">
        {allSettled ? (
          ...
          <button
            onClick={stop}
            className="inline-flex items-center justify-center gap-2 rounded-md border border-[var(--color-border)] px-4 py-2 text-sm hover:bg-[var(--color-border)]"
          >
            <svg
